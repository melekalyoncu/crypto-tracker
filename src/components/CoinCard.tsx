...
return (
<div className="rounded-2xl border border-white/10 p-4 hover:border-white/20 transition">
...
className={`rounded-full px-3 py-1 text-xs border ${isFav ? 'border-yellow-400 text-yellow-300' : 'border-black/10 text-black/70'}`}
